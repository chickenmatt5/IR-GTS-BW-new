...
def statana():
    ...
    if lilesum == csum:
    	print "File's checksum is correct(%s)." % (calcsum)
    else:
    	print "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    ...
    if total == 186:
	print "!!!!! IVs are unusually high, could be RNG abused. !!!!!"
    elif total >= 187:
        print "!!!!!!!!!!!!!!!!!"
	print "IVs are too high."
	print "!!!!!!!!!!!!!!!!!"

    evs = p[0x18:0x1e]
    total = evs[0] + evs[1] + evs[2] + evs[3] + evs[4] + evs[5]
    if total <= 507:
	print "Total EVs okay."
    elif total == 508:
	print "!!!!! Total EVs exactly 508. !!!!!"
    elif total == 510:
    	print "!!!!! Total EVs exactly 510. !!!!!"
    elif total >= 511:
	print "!!!!!!!!!!!!!!!!!!!"
	print "Total EVs over 510."
	print "!!!!!!!!!!!!!!!!!!!"
    print ''
	...
	print "!!!!! Probably female, check gender ratio (file's ratio is %d%%). !!!!!" % (genratio)
    if gender != cgender and gender == 2:
	print "!!!!! Probably male, check gender ratio (file's ratio is %d%%). !!!!!" % (genratio)
    ...
    if secid == 0:
	print "!!!!! Secret ID is 0 (could be an event). !!!!!"
